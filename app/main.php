...
<head>
    ...
    <!-- estilos -->
     ...
     <link rel="stylesheet" href="content/resources/css/menu.css">
     <link rel="stylesheet" href="content/resources/css/piePagina.css">

    <title>concretos y morteros</title>
</head>
<body>
    <div class="app">
        <div class="contenedor_menu"></div>
        <div id="contenidoDinamico" class="contenido"></div>
        <div class="piePagina"></div>
    </div>
    
    <script type="module" src="backend/cargaDinamica/cargarPagina.js"></script>
